-- Generation time: Thu, 16 Jul 2020 12:29:12 +0000
...
CREATE TABLE `authors` (
  ...
  `travel_doc` int(9) NOT NULL,
  UNIQUE KEY `travel_doc` (`travel_doc`),
  UNIQUE KEY `travel_doc_2` (`travel_doc`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

INSERT INTO authors VALUES ('Ms.','Cleo','Wyman','2012-08-27','CN','0'),
('Ms.','Karli','Glover','1978-07-05','PT','1'),
('Dr.','Joanne','Rempel','2008-06-23','IE','2'),
('Mrs.','Rowena','Abbott','1977-09-14','MX','3'),
('Ms.','Electa','Morar','1973-12-16','CN','4'),
('Dr.','Ahmad','Haag','1973-02-02','IT','5'),
('Ms.','Jakayla','Zulauf','1996-07-16','GB','6'),
('Mrs.','Sydney','Lakin','2008-07-22','ES','7'),
('Dr.','Dayton','Bogan','1985-06-27','RU','8'),
('Mr.','Kristian','Bartoletti','1976-12-01','RU','9'),
('Ms.','Ebony','Ernser','1986-08-07','CA','11'),
('Miss','Damon','Frami','1978-11-17','FR','12'),
('Dr.','Marcella','Langworth','1982-01-08','CA','19'),
('Mrs.','Scotty','O''Kon','1979-06-17','RU','20'),
('Mrs.','Elvis','Smith','1977-07-30','GB','25'),
('Prof.','Dorthy','Legros','1993-09-16','RU','28'),
('Prof.','Noel','Rippin','2003-06-11','CN','29'),
('Mrs.','Noel','Ernser','1999-10-06','DE','32'),
('Dr.','Alphonso','Medhurst','1988-03-28','GB','40'),
('Mr.','Kaylie','Jaskolski','2006-05-29','FR','42'),
('Mr.','Sydnee','Marks','2012-02-22','IN','43'),
('Dr.','Torrance','Koss','1971-05-12','RU','48'),
('Ms.','Tabitha','Mraz','2002-06-24','PT','49'),
('Miss','Earnestine','Connelly','1996-12-27','ES','67'),
('Ms.','Josue','Murray','2014-02-18','PT','69'),
('Dr.','Ernestina','Renner','2014-04-21','IE','70'),
('Mrs.','Elinor','Hudson','1999-07-24','PT','72'),
('Prof.','Gwendolyn','Olson','1978-07-18','DE','75'),
('Mr.','Octavia','Jenkins','2006-12-09','CN','76'),
('Mrs.','Christian','Goldner','1992-03-13','ES','82'),
('Miss','Dayna','Pagac','1998-04-08','MX','83'),
('Dr.','Marlon','Bechtelar','1994-08-15','IN','84'),
...
('Prof.','Jewel','Larkin','2006-06-27','FR','538'),
('Ms.','Mavis','Wisozk','2009-05-05','IE','624'),
...
('Ms.','Karli','Heaney','1973-06-12','MX','5390'),
('Prof.','Bart','Muller','1989-04-10','ES','5466'),
('Prof.','Wilhelmine','Abernathy','1984-12-16','FR','5782'),
('Dr.','Amparo','Dach','1971-01-22','CA','5860'),
